...
<article <?php post_class($is_card
  ? 'border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition-shadow bg-white'
  : 'border-b border-gray-100 pb-5 sm:pb-6 mb-5 sm:mb-6'); ?>>
  ...
  <div class="<?php echo $is_card ? 'p-4 sm:p-5' : ''; ?>">
    ...
    <h2 class="text-base sm:text-lg lg:text-xl font-semibold mb-1.5 sm:mb-2 leading-snug">
      <a href="<?php the_permalink(); ?>" class="text-gray-900 no-underline hover:text-primary transition-colors">
        <?php the_title(); ?>
      </a>
    </h2>

    <div class="text-xs sm:text-sm text-gray-400 mb-2 sm:mb-3 flex flex-wrap items-center gap-x-3">
